...
* **AI Engineering:** Researching and deploying RAG (Retrieval-Augmented Generation) and NLP models via SAP AI Core.
...
* **Data & AI:** Qdrant (Vector Search), ScyllaDB, CosmosDB, SAP AI Core, BERT/Candle.
* **Cloud:** SAP BTP, Azure, Google Cloud, AWS, Cloudflare Workers.

### Validations
* **ScyllaDB:** 5x Certified.
* **Microsoft:** Azure Fundamentals (AZ-900).
* **Apple:** Apple Searh Ads
